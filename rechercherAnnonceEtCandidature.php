...
session_start();
      ...
      if(isset($_POST['domaine'])){ $_SESSION['domaine'] = $_POST['domaine']; }
      if(isset($_POST['nature'])){ $_SESSION['nature'] = $_POST['nature']; }
...
<section class = 'container resultat-de-recherche'>
        ...
        <?php include("LesObjets/ObjetDeRechercheAnnonceEtCandidature.php"); ?>
