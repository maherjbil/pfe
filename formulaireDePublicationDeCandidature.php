...
<?php
	...
	$gdf = new GenerateurDuFormulaire();
		...
		echo "<div class = 'col-md-10 col-md-offset-1 text-center'>";
				...
				echo "<div class = '4'><p class = 'lead'>Deposer votre CV</p>".$gdf->form('f45','deposerCandidature.php',"post").$gdf->input("file","cv","cv","form-control")."<div class = 'col-md-2'><span id = 'erreurCV'></span></div>".$gdf->submit("envoyerCV","envoyerCV","envoyer","btn btn-default")."</div>";
		...
		if(isset($_GET['result'])){
			...
			if($_GET['result'] == 'true'){
				...
				echo "<b>Votre CV a ete publie</b>";

			}
			else{

				echo "<b>Echec de publication du CV veuillez reessayer</b>";
