							...
							foreach($listFavoris as $object){
									...
									echo "<div class = 'col-md-10 col-md-offset-1'>";
										...
										echo "<div class = 'rubrique'>";
											...
											echo "<div>Publiee le : ".$object->datePublication."</div>";
											echo "<button><a href = 'afficherAnnonces.php?idAnnonces=".$object->idAnnonces."'>afficher</a></button>";
